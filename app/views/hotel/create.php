...
<head>
    ...
    <title>Agregar Hotel - Sistema de Hoteles</title>
...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title"><i class="fas fa-plus-circle"></i> Agregar Nuevo Hotel</h2>
            </div>
            <div class="card-body">
                <form method="POST" id="hotelForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-input" placeholder="Ingrese el nombre del hotel" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="category" name="category" value="3" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-textarea" placeholder="Describa brevemente el hotel y sus servicios" required></textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="address" name="address" class="form-input" placeholder="Ingrese la dirección completa" required>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="district" name="district" class="form-input" placeholder="Ej: Huanta" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="province" name="province" class="form-input" placeholder="Ej: Huanta" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="department" name="department" class="form-input" placeholder="Ej: Ayacucho" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="tel" id="phone" name="phone" class="form-input" placeholder="Ej: (066) 123456" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" class="form-input" placeholder="Ej: info@hotel.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="website" name="website" class="form-input" placeholder="Ej: https://www.mihotel.com">
                    ...
                    <div class="map-container">
                        <div class="map-placeholder">
                            <i class="fas fa-map-marked-alt"></i> Mapa de ubicación (se mostraría aquí con coordenadas reales)
                        </div>
                    </div>
    ...
    <script>
        ...
        // Inicializar con 3 estrellas por defecto
        stars.forEach(star => {
